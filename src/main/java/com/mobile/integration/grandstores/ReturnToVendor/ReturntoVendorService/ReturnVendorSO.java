...
public class ReturnVendorSO extends NamedParameterJdbcDaoSupport {
    ...
    private ReturnToVendorPackage returnvendorpkg;
        ...
        // GET_RTV_RECEIPT_NUM
        public ResponseEntity<APIResponse> getRTVReceiptNumber(Map<String, Object> content) {
            ...
            Map<String, Object> ls=returnvendorpkg.getRTVReceiptNumber(P_INVENTORY_ORG_ID, P_RECEIPT_NUM, P_LIKE_COND_FLAG);
  ...
  public ResponseEntity<APIResponse> getRtvItemDetailCr(Map<String, Object> content) {
    ...
    Map<String, Object> ls=returnvendorpkg.getRTVItemDetailCr(P_INVENTORY_ORG_ID, P_RECEIPT_NUM, P_SHIPMENT_NUM, P_PO_NUMBER, P_RELEASE_NUM);
