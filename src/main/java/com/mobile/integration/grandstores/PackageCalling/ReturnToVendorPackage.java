...
public class ReturnToVendorPackage {
  ...
  public Map<String, Object> getRTVReceiptNumber(
    ...
    List<SqlParameter> parameters = Arrays.asList(
      ...
      new SqlParameter(Types.NVARCHAR), 
      new SqlParameter(Types.NVARCHAR), 
      new SqlOutParameter("P_RTV_RCPT_NUM_RS", Types.REF_CURSOR)
      );

    return jdbcTemplate.call(new CallableStatementCreator() {
      @Override
      public CallableStatement createCallableStatement(Connection con) throws SQLException {
        CallableStatement cs = con.prepareCall("{call XXGS_MOB_UTIL_PKG.GET_RTV_RECEIPT_NUM(?,?,?,?)}");
